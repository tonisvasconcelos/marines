...
const translations = {
  'en-US': {
    ...
    vessels: {
      ...
      delete: 'Delete',
      deleteConfirm: 'Are you sure you want to delete this vessel? This action cannot be undone.',
      deleteError: 'Failed to delete vessel',
      selectAgent: 'Select Agent',
      addAgent: 'Add Agent',
  ...
  'pt-BR': {
    ...
    vessels: {
      ...
      noPositionHistory: 'Nenhum histórico de posições disponível',
      tabs: {
        overview: 'Visão Geral',
        customers: 'Clientes',
        agents: 'Agentes',
      ...
      delete: 'Excluir',
      deleteConfirm: 'Tem certeza de que deseja excluir esta embarcação? Esta ação não pode ser desfeita.',
      deleteError: 'Falha ao excluir embarcação',
      selectAgent: 'Selecionar Agente',
      addAgent: 'Adicionar Agente',
